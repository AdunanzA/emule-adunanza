...
private:
	...
	// share list access
	bool IsShared(CString strDir, bool bCheckParent = false);	// : shareSubdir - allow checking indirect share
	void AddShare(CString strDir, bool bWithSubdir);	// : shareSubdir - two-list version
