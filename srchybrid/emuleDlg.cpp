...
void CemuleDlg::ShowTransferStateIcon()
{
	...
	if (m_uUpDatarate > 1000 && m_uDownDatarate > 1000)  //  -> da risultati un pò sballati il mulo nativo. Sistemiamoli.
...
//  -> Riscritta da 0
/*  -> La gestione della chiusura di eMule AdunanzA è stata oggetto di numerose revisioni in parte dovute al forte cambiamento del codice dalle precedenti versioni.
