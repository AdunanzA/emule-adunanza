...
public:
	...
	static int      m_iDetectuPnP; //leuk_he autodetect in startup 
	...
	static	int  	GetUpnpDetect()					{ return m_iDetectuPnP; } //leuk_he autodetect upnp in 
	static	void    SetUpnpDetect(int on)				{ m_iDetectuPnP=on; } //leuk_he autodetect upnp in 
	...
	static	CStringList sharedsubdir_list;	// : shareSubdir
...
//<<< JvA::SLS [enkeyDEV]
static	uint8	m_uiStartUpFlag; //  -> miglioria per dispositivi mobili
