...
{
    SetTimer( 0x1000, 1000, 0 ); //Ogni secondo faccio il controllo dello stato della pagina web.
}
...
void AduWebBrowser::OnTimer( UINT_PTR nIDEvent )
{
