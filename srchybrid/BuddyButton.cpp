...
static LRESULT CALLBACK BuddyButtonSubClassedProc(HWND hWnd, UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	...
	{
		case WM_NCDESTROY:
			SetWindowLongPtr(hWnd, GWLP_USERDATA, (LONG_PTR)pfnOldWndProc);
...
{
	FARPROC lpfnOldWndProc = (FARPROC)SetWindowLong(hwndEdit, GWLP_USERDATA, (LONG_PTR)BuddyButtonSubClassedProc);
