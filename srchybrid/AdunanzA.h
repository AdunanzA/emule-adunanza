...
// quando eseguo update di nodes.dat?
...
//velocità indicative in kbyte di download minimo del tipo di connessione.
...
// Frequenza CPU Minima per configurazione di connessioni (hz)
// PER ORA NON OPERATIVO #define CPU 1500
// Capacità download massima
#define ADSL1 128
#define ADSL2 256
#define ADSL4 512
#define ADSL6 768
...
// Nuova tipologia di riconoscimento connessione non più basata su IP ma su velocità di connessione.
...
// refresh automatico file condivisi
#define ASFU_OFF		0
...
//ICS  - Dynamic Block Request [NetFinity]
...
// Chunk minimo per client esterni
