...
public:
	...
	bool			AddReqBlock(Requested_Block_Struct* reqblock, const bool bChecksNecessary = true); //>>> ::Optimization
...
protected:
    ...
    UINT		m_slotNumber;
	//bool		m_bCollectionUploadSlot;  -> non serve più
...
public :
	...
	uint32 droptime; // Ottimizzazione gestione upload 
