...
private:
	...
	bool	FileSystemTreeIsShared(CString strDir, bool bCheckParent = false, bool bCheckIncoming = false,bool bOnlySubdir = false, bool bOnlyNormalShared = false);	// : shareSubdir - allow checking indirect share
